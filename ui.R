...
tabPanel("Upload a tracing",
	sidebarLayout(
		sidebarPanel(
			...
			selectInput('.tracing_brain', 'Template brain (FCWB – FlyCircuit; FAFB - whole EM brain; JFRC2 – Janelia FlyLight; IS2 – Cambridge; T1 – Vienna)', c('Select a template brain', 'FCWB', 'FAFB14', 'JFRC2', 'IS2', 'T1')),
